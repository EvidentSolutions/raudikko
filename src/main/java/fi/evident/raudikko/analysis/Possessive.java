...
public enum Possessive implements AnalysisClass {

    FIRST_SINGULAR("1s", "O1y"),
    SECOND_SINGULAR("2s", "O2y"),
    FIRST_PLURAL("1p", "O1m"),
    SECOND_PLURAL("2p", "O2m"),
    THIRD("3", "O3");

    private final @NotNull String legacyCode;
    private final @NotNull String morphologyTag;

    Possessive(@NotNull String legacyCode, @NotNull String morphologyTag) {
