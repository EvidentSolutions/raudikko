...
public enum Comparison implements AnalysisClass {

    COMPARATIVE("comparative", "Cc"),
    SUPERLATIVE("superlative", "Cs"),
    POSITIVE("positive", "-"); // not present in the model output

    private final @NotNull String legacyCode;
    private final @NotNull String morphologyTag;

    Comparison(@NotNull String legacyCode, @NotNull String morphologyTag) {
