...
public interface Analyzer {
     ...
     */
    default @NotNull List<Analysis> analyze(@NotNull CharSequence word) {
        return analyze(word, Integer.MAX_VALUE);
    }
    ...
    default @NotNull List<String> baseForms(@NotNull CharSequence word) {
        ...
        ArrayList<String> baseForms = new ArrayList<>(analyses.size());
        for (Analysis analysis : analyses) {
            String baseForm = analysis.getBaseForm();
            if (baseForm != null && !baseForms.contains(baseForm))
